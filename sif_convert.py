# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 11:54:57 2021
...
put this script in a directory with .sif files
...
for i in range(len(files)):
    if(files[i][-4:]==".sif"):
        ...
        x,y,vals=get_xy_fromsif(files[i])
        out=[]
        ...
        out_file=join(file_path,files[i][:-4]+"_conv.txt")
